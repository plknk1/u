...
local PepsiUi = library:CreateWindow({
    Name = "Questy Hub Script PC",
    Theme = {
        Image = "rbxassetid://7483871523",
        Info = "QUESTY X HUB PAID SCRIPT",
        Background = {
...
local Auto = PepsiUi:CreateTab({
    Name = "AutoItem/Quest"
})

local PVP = PepsiUi:CreateTab({
    Name = "Players"
})
...
local CR = Genaral:CreateSection({
    Name = "[ Script ]",
    Side = "Left"
})

local KUY = CR:AddLabel({
    Name = "Script By @_plknk1"
})
...
local Time = StartKaitan:AddLabel({
    Name = "Executor Time"
})
...
local AutoFarm = Genaral:CreateSection({
...
spawn(function()
	...
	local BossFarm = Genaral:CreateSection({
    Name = "[ Boss Farm ]",
    Side = "Left"
})
...
spawn(function()
    ...
    local FightingStyle = Genaral:CreateSection({
		Name = "Fighting Style",
		Side = "Left"
	})
	...
	local Settings = General:CreateSection({
...
local Up = General:CreateSection({
	Name = "Up Stats",
	Side = "Right"
})
...
local Mas = General:CreateSection({
	Name = "Farm Mastery",
	Side = "Right"
})
...
local SetMas = General:CreateSection({
...
local CakePrinceSection = General:CreateSection({
	Name = "Cake Prince 🍰",
	Side = "Left"
})
...
spawn(function()
 ...
 local BoneSection = General:CreateSection({
	Name = "Bone 🦴",
	Side = "Left"
})
...
local Observation = General:CreateSection({
	Name = "Observation",
	Side = "Right"
})
...
local FactoryFarm = General:CreateSection({
	Name = "FactoryFarm ☢️",
	Side = "Left"
})
...
Auto2:AddToggle{(
Name = "Auto Buy Enchancement Colour",
