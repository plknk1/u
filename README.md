...
Imagelogo.ZIndex = 2
Imagelogo.Image = "rbxassetid://15549713894" --เปลี่ยนรูป Logo ตรงนี้
...
local GUI = library:new("Questy Hub","[ RightControl ]")
local Genera = GUI:Tap("Genera")
local Stats = GUI:Tap("Stats")
local Combat = GUI:Tap("Combat")
local Teleport = GUI:Tap("Teleport")
local Dungeon = GUI:Tap("Dungeon")
local Shop = GUI:Tap("Shop")
local Devil Fruit = GUI:Tap("Devil Fruit")
